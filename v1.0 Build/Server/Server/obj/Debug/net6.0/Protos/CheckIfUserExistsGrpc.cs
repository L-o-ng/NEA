...
namespace Server {
  public static partial class CheckerIfUserExists
  {
    ...
    /// <summary>Base class for server-side implementations of CheckerIfUserExists</summary>
    [grpc::BindServiceMethod(typeof(CheckerIfUserExists), "BindService")]
    public abstract partial class CheckerIfUserExistsBase
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::Server.Exists> CheckUser(global::Server.Query request, grpc::ServerCallContext context)
      {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static grpc::ServerServiceDefinition BindService(CheckerIfUserExistsBase serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          .AddMethod(__Method_CheckUser, serviceImpl.CheckUser).Build();
    }
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, CheckerIfUserExistsBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_CheckUser, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Server.Query, global::Server.Exists>(serviceImpl.CheckUser));
    }
