...
namespace Server {
  public static partial class DeleterMazes
  {
    ...
    /// <summary>Base class for server-side implementations of DeleterMazes</summary>
    [grpc::BindServiceMethod(typeof(DeleterMazes), "BindService")]
    public abstract partial class DeleterMazesBase
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::Server.SuccessAcknowledge> DeleteMaze(global::Server.DeleteRequest request, grpc::ServerCallContext context)
      {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static grpc::ServerServiceDefinition BindService(DeleterMazesBase serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          .AddMethod(__Method_DeleteMaze, serviceImpl.DeleteMaze).Build();
    }
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, DeleterMazesBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_DeleteMaze, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Server.DeleteRequest, global::Server.SuccessAcknowledge>(serviceImpl.DeleteMaze));
    }
